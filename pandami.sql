...
/****** Object:  Database [bddPandami]    Script Date: 21/01/2021 10:59:53 ******/
CREATE DATABASE [bddPandami]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'bddPandami', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\bddPandami.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'bddPandami_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\bddPandami_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
